...
$SQL="SELECT  
	...
	((contratos.precio_lista-contratos.descuento)*contratos.tipo_cambio) AS precio_neto,
	(contratos.enganche*contratos.tipo_cambio) AS enganche,
	((contratos.precio_lista)*contratos.tipo_cambio) AS precio_lista,
...
CONCAT(ase.primer_nombre,' ',ase.segundo_nombre,
	...
	if (isset($id)){
		if ($id!=""){
			...
			$SQL.=" AND	contratos.estatus IN (1,13) ";	
		}
	}else{
		$SQL.=" AND	contratos.estatus IN (1,13) ";	
	}
...
?>    
 ...
 <?php  }  ?>
  ...
  <tr style="background:#E5E5E5">
    ...
    <td align="center"><?php echo number_format($_valor_cuota,2);?></td>
