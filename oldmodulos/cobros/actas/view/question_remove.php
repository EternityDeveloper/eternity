  ...
  <div class="modal-dialog"  style="width:500px;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">DESEA QUITAR DEL ACTA?</h4>
      </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
              <td width="120"><table width="444" border="0" cellspacing="0" cellpadding="0" >
                <tr>
                  <td width="120" align="left"><strong>CONTRATO:</strong></td>
                  <td width="324"><?php echo $ct->serie_contrato." ".$ct->no_contrato;?></td>
                </tr>
                <tr>
