  ...
  <div class="modal-dialog"  style="width:500px;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">REMOVER PRODUCTO</h4>
      </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
              <td width="120"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                  <td colspan="2" align="left"><strong>POR QUE?</strong></td>
                </tr>
                <tr>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="prod_realizar_cambio" class="btn btn-primary">Proceder</button>
      </div>
    </div>
  </div>
</div>