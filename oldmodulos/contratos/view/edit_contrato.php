...
<div id="contrato_div" style="height:400px;width:1200px;"  >
  <table width="98%" border="0" cellpadding="0" cellspacing="0"  id="contrato_main_page">
    <tr>
      <td valign="top">
        <form name="form_contrato" id="form_contrato" method="post" action="" class="fsForm  fsSingleColumn" onsubmit="return false;">
                  ...
                  <td width="100%" align="left"><h2  style="background-color:#CCC">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><span id="bt_edit_beneficiario1" style="float:right;margin-right:10px;margin-top:0px;padding-top:0px;top:-30px;cursor:pointer"><img src="images/edit_user.png" width="25px" height="25px" /></span></td>
                      </tr>
                    </table></h2></td>
                </tr>
                <tr>
                  ...
                  <td width="100%" align="left"><h2  style="background-color:#CCC">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><span id="bt_edit_beneficiario2" style="float:right;margin-right:10px;margin-top:0px;padding-top:0px;top:-30px;cursor:pointer"><img src="images/edit_user.png" width="25px" height="25px" /></span></td>
                      </tr>
                    </table></h2></td>
                </tr>
                <tr>
                  ...
                  <td width="100%" align="left">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><span id="edit_dt_representante1" style="float:right;margin-right:10px;margin-top:0px;padding-top:0px;top:-30px;cursor:pointer"><img src="images/edit_user.png" width="25px" height="25px" /></span></td>
                      </tr>
                    </table></h2>
                  </td>
                </tr>
                  ...
                  <td align="left"><h2  style="background-color:#CCC;padding:5px 5px 5px 5px;" >
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><span id="edit_dt_representante2" style="float:right;margin-right:10px;margin-top:0px;padding-top:0px;top:-30px;cursor:pointer"><img src="images/edit_user.png" width="25px" height="25px" /></span></td>
                      </tr>
                    </table></h2></td>
                </tr>
                <tr>
                  ...
                  <tr>
                    <td align="left" style="padding-left:10px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                      ...
                      <tr>
                        ...
                        <td id="nombre_asesor" style="font-size:14px;"><?php echo $asesores[0]['nombre']." ". $asesores[0]['apellido']; ?></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
...
inventario_jardines.`id_jardin`=producto_contrato.id_jardin AND inventario_jardines.osario=producto_contrato.osario ) 
...
?>          
            ...
            <tr>
              <td align="left" id="listado_productos">
<?php 
		...
		while($row=mysql_fetch_assoc($rs)){ 
			...
			$id=System::getInstance()->Encrypt(json_encode($row));
              ...
              <tr>
                <td width="80%" id="title_<?php echo $rand;?>"><?php echo $row['id_jardin']."-". $row['id_fases']."-". $row['bloque']."-".$row['lote'].$row['osario'];?></td>
                <td><img class="edit_product" id="<?php echo $rand;?>" product_id="<?php echo $id;?>" style="cursor:pointer;float:right" src="images/subtract_from_cart.png" /></td>
              </tr>
                  ...
                  <tr>
                    <td class="titlest"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td><img class="edit_product" id="<?php echo $rand;?>2" product_id="<?php echo $id;?>" style="cursor:pointer;float:right" src="images/subtract_from_cart.png" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
...
<?php 		}
 ...
 ?></td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:5px">
            <tr>
              <td><h2  style="background-color:#999">Documentos </h2> <button type="button" id="bt_add_document"  >Agregar</button></td>
            </tr>
             <tr>
              <td>&nbsp;</td>
            </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:5px">
            ...
            <tr>
              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                <tr>
                  <td><strong>FECHA DE VENTA</strong></td>
                  <td style="font-size:14px;"><input type="text" name="fecha_venta" id="fecha_venta" size="10" class="textfield_input required" value="<?php echo $contrato->fecha_venta ?>" disabled="disabled"/></td>
                </tr>
                <tr>
                  <td><strong>FECHA PRIMER PAGO</strong></td>
                  <td  style="font-size:14px;"><input type="text" name="fecha_primer_pago" id="fecha_primer_pago" size="10" class="textfield_input required" value="<?php echo $contrato->fecha_primer_pago?>" disabled="disabled"/></td>
                </tr>
                <tr>
                  <td width="215"><strong>FORMA DE PAGO</strong></td>
                  <td width="685"  style="font-size:14px;"><select name="forma_pago" id="forma_pago" class="textfield_input required" style="width:200px;">
                    <option value="">Seleccione</option>
                    <?php 

$SQL="SELECT * FROM `contratos_metodo_cobro`  ";
$rs=mysql_query($SQL);
while($row=mysql_fetch_assoc($rs)){
	$encriptID=System::getInstance()->Encrypt($row['cmc_codigo']);
?>
                    <option value="<?php echo $encriptID?>"><?php echo $row['cmc_descripcion']?></option>
                    <?php } ?>
                    </select></td>
                </tr>
                <tr>
...
WHERE sys_direcciones.serie_contrato='".$contrato->serie_contrato."' AND sys_direcciones.no_contrato='".$contrato->no_contrato."' ";
		...
		while($row=mysql_fetch_assoc($rs)){
			 echo $row['direccion'];
			 $id_address=System::getInstance()->Encrypt($row['id_direcciones']); 
			...
			$id_dir=base64_encode(json_encode($ubicacion));
		}
 	 
		?></span>
     <button type="button" id="bt_add_direccion" data="<?php echo $id_dir;?>" id_address="<?php echo $id_address;?>"><?php if ($cant>0){echo "Cambiar"; }else{ echo "Agregar";}?></button> </td>
                </tr>
              </table></td>
            </tr>
            <tr>
      ...
      <td valign="bottom"><table width="300"  border="0" align="right" cellpadding="0" cellspacing="0"  style="background:#FFF;border:#CCC solid 1px;">
        ...
        <tr class="detalle_costo">
          <td style="padding-left:8px;padding-right:5px;padding-bottom:5px;" ><table width="100%" border="0" cellspacing="2" cellpadding="2" style="padding-left:8px;;padding-right:5px;vertical-align: baseline;">
               <tr>
                 ...
                 <td style="padding-top:10px;padding-left:5px;border-bottom-style:double;" id="dt_capital_total_a_pagar2"><?php echo $contrato->tipo_moneda?></td>
               </tr>
               <tr>
            ...
            <tr>
              ...
              <td style="padding-top:10px;padding-left:5px;border-bottom-style:double;" id="dt_total_interes_a_pagar"><?php echo number_format($contrato->interes,2);
        ...
        <tr class="detalle_costo">
          <td style="padding-left:8px;padding-right:5px;padding-bottom:5px;" >&nbsp;</td>
        </tr>
        <tr class="detalle_costo">
          <td  >&nbsp;</td>
        </tr>
    ...
    <tr>
	  ...
	  //if ($ct->hasPagoDeIncial($contrato->serie_contrato,$contrato->no_contrato)){
	  ?><button type="button"class="greenButton" id="bt_contrato_activar">Activar Contrato</button>
      <?php // } ?>
        &nbsp; <button type="button" class="greenButton"  id="bt_imprimir" contrato="<?php echo $_REQUEST['id'] ?>">Imprimir</button> &nbsp;<button type="button" class="redButton" id="bt_contrato_cancel">Anular Solicitud</button></td>
      <td align="center" valign="top">&nbsp;</td>
      </tr>
    <tr>
      <td align="center" valign="top">&nbsp;</td>
