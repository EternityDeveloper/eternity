...
var GAbonoCapital = new Class({
	...
	doView: function(contrato){
		...
		instance.post("./?mod_cobros/delegate&view_abono_capital",{ 
			...
			$("#procesar_abono").click(function(){
				...
				instance.post("./?mod_cobros/delegate&CGAbonoCapital",{
						"monto_abono":monto_abono,
						"plazo":plazo,
						"cambio_plazo":cambio_plazo,
						'contrato':instance._contrato,
