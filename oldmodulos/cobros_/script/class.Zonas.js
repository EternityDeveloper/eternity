...
var Zonas = new Class({
	...
	doInit : function( ){ 
		...
		$("#btz_agregar").click(function(){ 
			instance.doCreateZonaView();
		});
		...
		$(".list_zona_item").click(function(){
			instance.doEditZonaView($(this).attr("id"));
		});
		
		var isLoading=false;
		$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
		 	
			if ($(this).attr("id")=="z_map_tb" && isLoading==false){
				instance.showZonaOnMap(); 	
				isLoading=true;
			}
		}) 
