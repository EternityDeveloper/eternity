...
<div id="myTabContent" class="tab-content">
	...
	//		echo  '<a href="#">'.."</a>"."<br>";
		...
		foreach($servicios as $key =>$srv){
			if ($srv['id_estatus']==59){
				echo  '<span  style="background:#F00;color:#FFF;padding:3px;">'.$srv['serv_descripcion']." (".$srv['estatus'].")</span>"."<br>";
			}else{
		...
		?></td>
                            ...
                            <tr>
                              ...
                              <td style="margin:0px;padding-left:10px;"><?php echo $data['ESTATUS'];?> (<?php echo $data['tipo_ingreso'];?>)</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td height="25" align="left"  style="background-color:#CCCCCC"><strong>METODO  DE PAGO</strong></td>
                              <td style="padding-left:10px;"><span style="font-size:14px;">
                                <select name="metodo_cobro" id="metodo_cobro" class="textfield_input required" style="width:150px;" contrato="<?php echo $id_contrato?>">
                                ...
                                ?>
                                  <option value="<?php echo $row['cmc_codigo']; ?>" <?php if ($row['cmc_codigo']==$data['forpago']){?> selected="selected" <?php } ?>><?php echo $row['cmc_descripcion']?></option>
                                  <?php } ?>
                                </select>
                                <input name="<?php echo $id_contrato?>" type="button" class="agregar_comentary btn btn-primary"  value="Cambiar" id="<?php echo $id_contrato?>2"  id_nit="<?php echo $id_nit?>" style="width:80px;display:none" />
                              </span></td>
                            </tr>
                          </table></td>
		...
		if ($cdata->estatus==1 || $cdata->estatus==39 || $cdata->estatus==20 
			 ...
			 if ($protect->getIfAccessPageById(152) || $protect->getIfAccessPageById(153)
					 || $protect->getIfAccessPageById(171)){ ?>
                                              <div class="btn-group dropup">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                  <?php if ($data['id_status']==1 || $cdata->estatus==20 || $cdata->estatus==54 || $cdata->estatus==47 || $cdata->estatus==23 || $cdata->estatus==28   ){ ?>
...
?>
			...
			// if ($protect->getIfAccessPageById(152)){ ?>
						...
						$SQL="SELECT * FROM `tipos_gestiones` where idtipogestion in ('INH','ABCAP','ABSAL','CTT','CPLAN','GPMN','NTDBT','REACT','PAMTO')";
							...
							?></td>
                                      ...
                                      <tr>
                                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <?php 
		//Si el contrato esta activo
		if ($cdata->estatus==1 || $cdata->estatus==39  || $cdata->estatus==20 || $cdata->estatus==24 || $cdata->estatus==54
		|| $cdata->estatus==47 ){ ?>
                                          <tr>
                                            <td> 
