...
$SQL="SELECT * FROM `tipo_documento` WHERE ID_TIPO_DOC in (2,3,4)";
$rs=mysql_query($SQL);
...
?>
    ...
    <tr>
      <td align="center"><button type="button" class="greenButton" id="bt_caja_process">&nbsp;Realizar pago Inicial&nbsp;</button>
