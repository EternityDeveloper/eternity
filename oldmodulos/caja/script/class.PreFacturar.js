/* Modulo de Pre-factura */
var PreFacturar = new Class({
	...
	*/
	doView : function(id_nit,contrato){ 
		...
		var accion={
			...
			onload: function(){
 			...
 			//	instance.doLoadRecibos(contrato); 
			//	if (tipo_movimiento!=""){
				$("#detalle_recibo").show();
				$("#pf_fdocumento").show();
	...
	doLoadRecibos: function(contrato,id_nit){
		var instance=this;
