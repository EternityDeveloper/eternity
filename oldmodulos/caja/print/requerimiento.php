...
<table width="335" border="0" align="center" cellpadding="5" cellspacing="0" >
  <tr>
    <td><table width="900" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="2" style="font-size:19px;"><strong>SERVICIOS MEMORIALES DOMINICANOS, S.R.L.</strong></td>
        </tr>
      <tr>
        <td width="550" valign="top"><table border="0" cellspacing="0" cellpadding="0" style="font-size:11px;" >
          <tr>
            <td >Av. 27 de Febrero No. 444 (Entre Av. Privada y Nuñez de Caceres), <br>
              Santo Domingo Norte, Santo Domingo</td>
            </tr>
          <tr>
            <td></td>
            </tr>
  ...
  <tr>
    <td style="font-size:12px"><strong>NOMBRE DE CLIENTE:</strong> <?php echo $client_data['id_nit'];?> - <?php echo $client_data['nombre_completo']?></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	$monto_total=0; 
 	foreach($mc_listado as $key =>$row){
		...
		?>     
      <tr>
        <td width="670"  style="font-size:12px;" ><?php echo $DESCRIPCION;?></td>
