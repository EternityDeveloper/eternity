...
var cxcGerentes = new Class({
	...
	doViewNotaCD  : function(){
		var instance=this; 
		instance.post("./?mod_planillas/delegate&listado_cxc_gerente",{doViewCDGerentes:true},function(data){   
			...
			$("#aplicar_nota_cd").click(function(){
				instance.post("./?mod_planillas/delegate&listado_cxc_gerente",
				{
					"tipo_m":tipo_m,
					"monto":monto,
	...
	cargarDetalleCxC  : function(row,id){
		var instance=this; 
		instance.post("./?mod_planillas/delegate&listado_cxc_gerente",{getDetallecxc:true,id:id},function(data){   
			row.child(data).show();
		});	
	}
