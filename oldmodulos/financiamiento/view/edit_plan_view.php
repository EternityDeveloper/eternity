...
<form name="form_financiamiento" id="form_financiamiento" method="post">
 <div class="fsPage fsPage2"  >
 
   <table width="100%" border="1">
    <tr>
      <td valign="top"><table  width="100%" border="1">
        <tr>
          <td><h2 id="h_">PLANES DE FINANCIAMIENTO</h2></td>
        </tr>
        <tr>
...
<?php
	...
	$data=$plan_fin->getListPlanesFinanciamiento();
...
?> 
              <tr class="enganche_<?php echo $plan['POR_ENGANCHE']?>">
                ...
                <td><a href="#" class="edit_plan_fin" id="<?php echo $EncryptID ?>"><img src="images/cross.png"  /></a></td>
              </tr>
<?php
}
?>  
