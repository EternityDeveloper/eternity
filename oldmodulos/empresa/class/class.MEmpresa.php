<?php 
/*
Clase que maneja el mantenimiento empresa
...
class MEmpresa{
	...
	public function getList($search=null){
		...
		$SQL="SELECT * FROM `empresa`
			INNER JOIN `sys_status` ON (sys_status.id_status=empresa.`estatus`) ";
		$rs=mysql_query($SQL);
		...
		while($row=mysql_fetch_assoc($rs)){
			...
			$row['settings']='<a href="#" id="'.$row['enc_id_caja'].'" class="edit_mante_emp"><img src="images/subtract_from_cart.png"  /></a>'; 
