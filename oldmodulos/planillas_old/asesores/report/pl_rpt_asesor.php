   ...
   <table width="97%" class="fsPage">
	  ...
	  $comision_pendiente=0;
	    while($row = mysql_fetch_array($result)){
		  $total_contrato=$total_contrato+1;
		  ...
		  $monto_comision=$monto_comision+$row['comision'];
		  $anulados=$anulados+$row['anulados'];
		  $bono_x_plan=$bono_x_plan+$row['bonoplan'];
		  $bonoaux=$bonoaux+$row['bonoaux'];
		  $diferidos=$diferidos+$row['diferidos'];
		  $retencion=$retencion+$row['retencion'];
	   ?>		
		  <tr>
             <td align="right"><?=$row['codigo_asesor']?></td>
             <td align="left"><?= utf8_encode($row['nombre']." ".$row['apellidos']);?></td>
	  ...
	  ?>
		  <tr>
		    <td align="right">&nbsp;</td>
		    <td align="left">&nbsp;</td>
		    <td align="right"><?php echo number_format($monto_comision,2);?></td>
		    <td align="right"><?php echo number_format($bono_x_plan,2);?></td>
		    <td align="right"><?php echo number_format($bonoaux,2);?></td>
		    <td align="right"><?php echo number_format($diferidos,2);?></td>
		    <td align="right"><?php echo number_format($anulados,2);?></td>
		    <td align="right"><?php echo number_format($retencion,2);?></td>
		    <td align="right"><?php echo number_format($monto_total,2);?></td>
     </tr>
