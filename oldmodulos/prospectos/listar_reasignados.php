...
if (isset($_REQUEST['submit_reasignacion_asesor'])){
...
if (isset($_REQUEST['asig_view'])){
	include("view/asignacion/asignar.php");
	exit;
} 
...
if (isset($_REQUEST['x_search'])){
	...
	$result=$prospecto->getReasignadoList();
...
$(function(){
	...
	_prospectos.createListTableReasignado('prospecto_list');
