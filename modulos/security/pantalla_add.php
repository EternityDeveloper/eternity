...
if (isset($_REQUEST['submit'])){
	...
	$roles= new ObjectSQL();
	$roles->Pantalla=$_REQUEST['Pantalla'];
	$roles->URL=$_REQUEST['URL'];
	$SQL=$roles->getSQL("insert","Pantallas");
	mysql_query($SQL);
...
<table width="100%" border="1">
  ...
  <tr>
    <td>Nombre:</td>
    <td><label>
      <input name="Pantalla" type="text" id="Pantalla" />
      </label>    </td>
  </tr>
  <tr>
    <td>Modulo:</td>
    <td><label>
      ...
      </label>    <input name="submit" type="hidden" id="submit" value="submit" /></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  </tr>
