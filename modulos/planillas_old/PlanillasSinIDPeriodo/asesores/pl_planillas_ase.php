...
/* SystemHtml::getInstance()->addTagScript("script/jquery.jstree.js");
 ...
 SystemHtml::getInstance()->addTagScriptByModule("class.opMantenimiento.js","planillas/asesores"); 
...
?>
   <!-- Despliega la Ventana Modal para Seleccionar los Datos de Periodo -->
	<script>
       var modalWindow;
          $(function(){
              modalWindow = new opMantenimiento('content_dialog');
...
<?php 
      ...
      $cadena = '"mes='.$_REQUEST['mes'].'&tipo_cierre='.$_REQUEST['tipo_cierre'].'&anio='.$_REQUEST['anio'].'"';
   ?>
	...
	$(document).ready(function() {
	   function format ( d ) {
	     ...
	     $("#refresh").click(function(){
		    window.location.href="?mod_planillas/asesores/view/pl_graba_datos&" + <?php echo $cadena; ?>;
	     });   
