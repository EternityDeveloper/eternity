var Contratos = new Class({
			...
			if (valid){
				var ds = { 
					...
					"forma_pago": $("#forma_pago").val(),
                                        "fecha_venta2":$("#fecha_venta2").val(),
					"oficial_n":$("#oficial_n").val(),
	...
	createView : function(prospectacion){
					...
					instance.post("./?mod_contratos/listar",
					{
						...
						person.addListener("personal_data_load",function(rs){
							...
							if (rs.valid){
								...
								var obx={hideParentesco:true};
								instance.processEditPersona(instance._dt_representante1.idnit,obx);
							}else{
								alert('Error al tratar de seleccionar el cliente!');	
							}
						});
		...
		$("#bt_contrato_generar").click(function(){
			...
			if (tipo_ingreso==""){
				valid=false;
				mensaje="Debe de seleccionar el tipo de ingreso";
			}	
