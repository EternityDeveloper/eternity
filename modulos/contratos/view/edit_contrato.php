            ...
            <tr>
              <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                <tr>
                  ...
                  <td style="font-size:14px;"><input type="text" name="fecha_venta2" id="fecha_venta2" size="10" class="textfield_input required" value="<?php echo $contrato->fecha_venta ?>" /></td>
                </tr>
                <tr>
                  <td><strong>FECHA PRIMER PAGO</strong></td>
                  <td  style="font-size:14px;"><input type="text" name="fecha_primer_pago" id="fecha_primer_pago" size="10" class="textfield_input required" value="<?php echo $contrato->fecha_primer_pago?>" /></td>
                </tr>
                <tr>
