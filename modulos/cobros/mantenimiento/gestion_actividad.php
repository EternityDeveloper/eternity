...
$(document).ready(function(){
	_mante.tableViewGestion("list_gestiones","gbutton_add",'gestiones_class');
  ...
  <table width="100%" border="1">
    <tr>
      <td width="50%" valign="top"><table width="100%" border="0">
        <tr>
          <td width="150%"><h2> Listado de Gestiones</h2></td>
        </tr>
        <tr>
          <td><button type="button" class="positive" name="gbutton_add"  id="gbutton_add" > <img src="images/apply2.png" alt=""/>Agregar </button></td>
        </tr>
        <tr>
          <td><table width="100%" border="0" class="display" id="list_gestiones" style="font-size:13px">
            <thead>
              <tr>
                <th>Descripción</th>
...
?>
              <tr>
                <td height="25"><?php echo $row['gestion']?></td>
                <td align="center" > <?php echo $row['genera_actividad']?></td>
                <td align="center" ><?php echo $row['Tiempo_max']?></td>
                <td align="center" ><?php echo $escalamiento1;?></td>
                <td align="center" ><?php echo $escalamiento2;?></td>
