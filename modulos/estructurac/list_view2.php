...
WHERE sys_directores_division.`codigo_gerente` = '". $ID_Agente ."' and sys_directores_division.status='1'";
...
?>
		<li id="gerentes_division"  ids="<?php echo $row_division['director_divicion_id_encript']?>"  gerente="<?php echo $gerente_id?>" rel="subgerente"> <a href="#"><?php echo $row_division['nombre']!=""?$row_division['nombre']:'No asignado'?>&nbsp;&nbsp;<strong>(Director de División)<?php echo $row_division['codigo_director']?></strong> </a>
...
?>
	<li id="gerentes_grupo" rel="director"  ids="<?php echo $row_gerente_g['idgerente_grupo_encript']?>" gerente="<?php echo $gerente_id?>" director="<?php echo $row_division['director_divicion_id_encript']?>" > <a href="#"><?php echo $row_gerente_g['nombre']!=""?$row_gerente_g['nombre']:'No asignado'?>&nbsp;&nbsp;<strong>(Gerente grupo de ventas)<?php echo $row_gerente_g['codigo_gerente_grupo']?></strong> </a>
...
?>
<li  id="asesor" ids="<?php echo $row_asesor['id_asesor_encript']?>" rel="seller"> <a href="#"><?php echo $row_asesor['nombre']!=""?$row_asesor['nombre']:'No asignado'?>&nbsp;&nbsp;<strong>(Asesor de Familia)<?php echo $row_asesor['asesor_id']?></strong> </a> </li>
