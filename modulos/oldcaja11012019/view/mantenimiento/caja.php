...
if (!isset($protect)){
	...
	SystemHtml::getInstance()->addTagScriptByModule("Class.MantenimientoCaja.js"); 
...
$(function(){
  	...
  	_man= new MantenimientoCaja('content_dialog');
...
<div id="man_caja" class="fsPage">
  <h2>Mantenimiento de caja</h2>
  <button id="create_caja" class="greenButton">Agregar caja</button>
