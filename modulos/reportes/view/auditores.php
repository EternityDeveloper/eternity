...
$SQL="
SELECT contratos.id_nit_ingreso,
 ...
 FROM `contratos`
WHERE  contratos.fecha_ingreso  BETWEEN '".$day_from." 00:00:00' and '".$day_to." 23:59:59'
and contratos.id_nit_ingreso not in ('00114045651','00116422460','09000219890','100000000025')
 GROUP BY contratos.id_nit_ingreso ) AS contratos
...
$SQL="SELECT  
	...
	COUNT(contratos.no_contrato) as CANTIDAD,
	SUM(contratos.no_productos) AS PRODUCTOS,
	SUM(((contratos.precio_lista-contratos.descuento)*contratos.tipo_cambio)) AS MONTO,	
...
?>  
  <tr> 
    ...
    <td width="100" align="center">Q. <?php echo number_format($rowx['MONTO'],2);?></td>
  </tr>
<?php } ?>  
<?php 	
if ($rowx['id_status']==1){
...
$SQL="SELECT  
	...
	' ',sys_personas.`primer_apellido`,' ',sys_personas.segundo_apellido) AS nombre_cliente,
		...
		' ',ase.`primer_apellido`,' ',ase.`segundo_apellido`) AS asesor,
...
while($rowar= mysql_fetch_assoc($rsar)){ 
 ...
 ?>       
      <tr>
        ...
        <td align="center"><?php echo $rowar['asesor']?></td>
        <td align="center"><?php echo $rowar['gerente']?></td>
...
$i++;
  ...
  <tr>
    ...
    <td align="center"><b>Q. <?php echo number_format($_MONTO,2);?></b></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
