...
?>  
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0"  > 
  <tr >
    ...
    <td width="100"  align="center">Q. <?php echo number_format($row['MONTO'],2);?></td>
  </tr>
...
$i++;
  ...
  <tr>
    ...
    <td width="100" align="center"><b>Q. <?php echo number_format($_MONTO,2);?></b></td>
  </tr>
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<?php } ?>
      <tr>
        ...
        <td align="center"><strong>Q.  <?php echo number_format($MONTO,2)?></strong></td>
        <td align="center"><strong>Q. <?php echo number_format($INICIAL,2);?></strong></td>
        <td align="center"><strong>Q. <?php echo number_format($DESCUENTOS,2);?></strong></td>
      </tr>
