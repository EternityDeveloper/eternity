	...
	$(document).ready(function() {
	   function format ( d ) {
		  ...
		  return '<table style="width: 70%; padding-left:50px;">' +
              ...
              var table = $("#ventas").DataTable({
				 "sAjaxSource": "./?mod_planillas/gerentes/view/pl_comision_ger&"+ <?php echo $cadena; ?>,
					/*"columns"    : [
					...
					"aoColumns": [
									...
									{ "mDataProp": "codigo_gerente", "sClass": "derecha" },
									{ "mDataProp": "nombre" },
									{ "mDataProp": "apellidos" },
	  ...
	  function saveData(parUno, parDos, parTres){
		...
		$("#procesar").click(function(){
			 $.post("?mod_planillas/gerentes/view/pl_graba_comiger",$("#frm_tbl_config").serializeArray(), function(data){
			 alert(data.mensaje);
