...
<table border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td  ><table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="250" style="font-size:16px;"><strong>Eternity Servicios Exequieles, S.A.</strong></td>
        </tr>
      <tr>
        <td width="100" valign="top"><table  border="0" cellpadding="0" cellspacing="0" style="font-size:12px;" >
          <tr>
            <td style="font-size:12px;">3ra. Ave. 16-52 Zona 10, Guatemala</td>
          </tr>
          <tr>
            <td style="font-size:12px;">C.C. Los Proceres S1.</td>
          </tr>
          <tr>
            <td style="font-size:12px;">Telefono: 502-2227-5700</td>
          </tr>
          <tr>
            <td style="font-size:12px;">Nit: 10211541-9</td>
          </tr>
          <tr>
 	...
 	foreach($mc_listado as $key =>$row){
		...
		?>
          <tr>
            ...
            <td width="80"  style="font-size:12px;">GTQ.  <?php echo number_format($row['MONTO']*$row['TIPO_CAMBIO'],2);?></td>
            </tr>
          <?php } ?>
          </table></td>
      </tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><table border="0"  cellpadding="0" cellspacing="0" >
              ...
              <tr>
                <td  style="font-size:12px;" ><strong>IVA:</strong></td>
