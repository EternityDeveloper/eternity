...
$listado= $pap->getListadoAsignado(UserAccess::getInstance()->getIDNIT());
...
?>
    <tr  >
      ...
      <td><button type="button" class="orangeButton lote_reasing" value="<?php echo $id;?>" >Asignar</button></td>
      <td><button type="button" class="orangeButton lote_review" value="<?php echo $id;?>">VER</button></td>
      </tr>
        <?php 
}
 ?>
